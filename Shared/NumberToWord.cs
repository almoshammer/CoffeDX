...
namespace CoffeDX.Shared
{
    public class NumberToWord
    {
        ...
        public string ConvertToEnglish()
        {
            ...
            formattedNumber += (retVal != String.Empty) ? (_intergerValue == 1 ? Currency.name : Currency.name) : String.Empty;
            ...
            formattedNumber += (decimalString != String.Empty) ? " " + (_decimalValue == 1 ? Currency.sub : Currency.sub) : String.Empty;
    ...
    public class CurrencyInfo
    {
        ...
        public CurrencyInfo(string name, string sub, string code, int partPrecision=2)
        {
            this.name = name;
            this.sub = sub;
            this.code = code;
